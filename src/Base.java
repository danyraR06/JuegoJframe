...
public class Base {
    ...
    public boolean intersecta(Object objObjeto) {
        if (objObjeto instanceof Base) {
            ...
            //se crea y declara un nuevo rectangulo de la clase rentangle
            Rectangle rctEsteObjeto = new Rectangle(this.getX(), this.getY(),
                    this.getAncho(), this.getAlto());
            Base plaObjeto = (Base) objObjeto;
            Rectangle rctObjetoParam = new Rectangle(plaObjeto.getX(),
                    plaObjeto.getY(), plaObjeto.getAncho(), plaObjeto.getAlto());
